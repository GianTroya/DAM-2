//este server nos da ttoda la información del sistema operativo
...
if (requrl.pathname === '/') {
    ...
    //cuando se llama a la ruta, claro
    } else if (requrl.pathname === "/osinfo") {
// dentro de un string la parte que está entre ${} es interpretada 
// como una expresión puede ser una operación matemática,
// una referencia  averiable o una llamada   a función
    res.writeHead(200, {'Content-Type': 'text/html'});
    res.end(
